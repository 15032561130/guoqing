package org.guoqing.bigdata.antun.test;
...
public class PingAnJieKouTest {
	...
	public void test002() {
		...
		builder.append("userName=李四&");

		builder.append("userSex=0&");

		builder.append("userBirth=1991-04-15&");

		builder.append("userPhone=18851645673&");
